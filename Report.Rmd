...
\begin{tabular}{|c|c|}
\hline
\textbf{Model} & \textbf{Baseline Hazard Function} \\
\hline
Exponential & $1/\lambda$ \\
\hline
Weibull & $\lambda^ppt^{p-1}$ \\
\hline
Lognormal & $\frac{(1/t\sigma)*\Phi(log(t)/\sigma)}{\phi(-log(t)/\sigma)}$ \\
\hline
Cox & - \\
\hline
\end{tabular}
...
\end{array}
$$
>>>>>>> d9dd9553570fd16f36f777a662b5c0561fe54585
