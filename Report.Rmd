...
MSE_table = tibble(
  ...
  "Weibull(0.5)" = c(MSE(result_0.5$exp_beta), MSE(result_0.5$weibull_beta), MSE(result_0.5$cox_beta)),
  "Weibull(2)" = c(MSE(result_2$exp_beta), MSE(result_2$weibull_beta), MSE(result_2$cox_beta)),
  "Weibull(5)" = c(MSE(result_5$exp_beta), MSE(result_5$weibull_beta), MSE(result_5$cox_beta)),
...
\small Table 2. MSEs from three models using 1000 simulations. Weibull models are denoted as Weibull($\gamma$).
...
\small Table 3. Mean (SD) of $\hat{\beta}$ from three models using 1000 simulations. Weibull models are denoted as Weibull($\gamma$).


\bigskip


In Table 3 above, we see the breakdown of the average estimated treatment effect for each model and baseline hazard function. (...)
